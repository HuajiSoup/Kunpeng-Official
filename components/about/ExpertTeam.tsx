      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-10">
          ...
          <p className="text-base text-slate-600 font-light max-w-2xl mx-auto leading-relaxed">
            汇聚行业顶尖人才，拥有多名适航委任代表(DER)及资深测试专家
          </p>
        </div>
              ...
              >
                ...
                <div className="aspect-square w-48 md:w-56 mx-auto rounded-xl bg-slate-100 mb-4 flex items-center justify-center overflow-hidden border-[0.5px] border-blue-500/20 group-hover:border-blue-500/50 transition-all duration-300 group-hover:shadow-[0_0_25px_rgba(59,130,246,0.2)] relative">
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute inset-0 rounded-xl border border-transparent bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-500 bg-[length:200%_100%] animate-[border-beam_3s_linear_infinite]" style={{
